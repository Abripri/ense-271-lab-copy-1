[![Button: Takes you back to the main assignment 2 page](https://img.shields.io/badge/%3C%20Back%20to%20Assignment%202-325A9A?style=flat&logoColor=325A9A&color=325A9A)](../)

# Assignment 2
Written below are the assignment instructions and submission requirements for lab assignment 2. They were provided by the lab instructor and were copied and pasted directly from the official lab document. 
...
Example directory (zipped): <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; a-tilson-sid-ense271-l2.zip <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ├── readme.md <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ├── sitemap.png <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; └── asset-inventory.ods <br> <br>
